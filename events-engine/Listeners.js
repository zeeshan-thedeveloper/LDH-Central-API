...
// Cache
const {requestsListCache,admin_accounts_cache, hosts_info_list_cache} = require('../cache-store/cache')
module.exports = {initEvents:()=>{
    emiter.on(events.INIT_CACHE,()=>{
        ...
        console.log('requestsListCache,adminAccountsCache,hosts_info_list_cache : have been intialized.')
    })
    // Requests
